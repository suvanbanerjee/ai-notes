      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-black rounded-lg shadow-sm border border-stone-200 dark:border-stone-800">
          <div className="text-center">
            ...
            <p className="mt-2 text-stone-600 dark:text-stone-400">Start taking smarter notes today</p>
          </div>
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-stone-500 dark:text-stone-400">
              ...
              <Link href="/login" className="font-medium text-stone-700 dark:text-stone-300 hover:text-black dark:hover:text-white transition-colors">
                Sign in
              </Link>
            </p>
          </div>
